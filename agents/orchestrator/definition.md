...
6. **Try again** (needs you): a new job for the same `briefVersion` with the failed job's input unchanged, using the queue's own retry and attempt representation.
