...
| 3 | Provenance | ≤10% of claims demoted by the §7 check on the last attempt; five hand spot-checks agree | bench (the percentage), Benny-san (the spot-checks) |
...
| 12 | Depth against the bar | brief A read module by module against Signal's May insurance pack; brief E against the legal exemplar; nothing the campaign agent needs is missing | Benny-san |
