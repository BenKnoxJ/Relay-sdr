...
export const campaignsCopy = {
  ...
  /**
   * Activity (final MVP pass): what happened to this campaign, from its own
   * record, newest first. Every line is a thing that happened, with who did
   * it and when; nothing is a count of work that has not happened.
   */
  ...
  activityBriefEdited: "Brief edited",
  activityBriefWidened: "Brief widened",
  activityVersion: "version",
  activityResearchDone: "Research finished",
  activityResearchPartial: "Research finished with parts unwritten",
  ...
  activityConfirmedChosen: "your pick",
  activityConfirmedRecommended: "the recommended play",
  activityLimit: "search limit",
  activityLawful: "Lawful basis",
  activityFound: "Found",
  activityFoundOf: "people of",
  activityFoundAsked: "asked for",
  activityHalted: "Finding people stopped:",
  activitySearchedAgain: "Finding people tried again",
  activitySearchedWithChoice: "Searched again with the kind of organisation you chose",
  activityKept: "Kept",
  activityDropped: "Dropped",
  activityAccount: "at one account",
  activityRevealConfirmed: "Reveal confirmed:",
  activityRevealEmails: "emails, up to",
  activityRevealed: "Revealed",
  activityRevealedKnown: "already known",
  activityRevealedWithout: "without a usable email",
  ...
  reviewShowReviewed: "Show reviewed",
  reviewCollapseReviewed: "Collapse reviewed",
  reviewAllKept: "all kept",
  reviewAllDropped: "all dropped",
  reviewMixed: "kept",
  reviewChange: "Change",
  reviewToDecide: "to decide",
  revealEstimateShort: "up to",
  revealEstimateFor: "credits for",
