...
export const campaignsCopy = {
  ...
  whyFits: "Why they fit:",
  relatedFits: "Their title is close to the plan's search, but is not one of the roles research described.",
  reviewKeep: "Keep",
  reviewDrop: "Drop",
  ...
  revealKeptAbout: "Revealing the emails of the people you keep would use about",
