...
export const KNOWLEDGE_SCRUB =
  /\b(Signal|Canvas|Prism|Pitch|Forge|Critic|Sentinel|Scribe|Glitch|Vector)\b|\bauthor:\s*(signal|canvas|prism|pitch|forge|vector)\b|\b(signal|canvas|prism|pitch|forge|vector)-[a-z0-9-]+\.md\b|~\/(vault|wiki|agents|projects)|\/home\/clawdbot|\bBenny\b/;
